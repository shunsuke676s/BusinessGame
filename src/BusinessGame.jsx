  ...
  return (
    <div className="screen home-screen">
      ...
      <div className="panel about-panel">
        ...
        <p>
          発注してから商品が届くまでにはタイムラグがあり、急な欠品には割高な「緊急発注」で対応することもできます。
          信用度は受注の実績に応じて上下し、将来届く注文の規模にも影響するため、目先の利益だけでなく
          継続的な取引関係を意識した経営判断が求められます。
        </p>
        <p>
          プレイ内容はサーバー側で独自に再計算され、その結果が正式なスコアとしてランキングに登録される仕組みも備えています。
          難易度・営業期間ごとに分かれたランキングで、他のプレイヤーと経営の腕前を比較することもできます。
        </p>
      </div>
